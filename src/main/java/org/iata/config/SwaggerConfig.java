    ...
    public OpenApiCustomiser schemaCustomizer() {
        ...
        return openApi -> openApi
                ...
                .schema("MovementTimes", ModelConverters.getInstance()
                        .resolveAsResolvedSchema(new AnnotatedType(MovementTimes.class)).schema)
                ...
                .schema("Thing", ModelConverters.getInstance()
                        .resolveAsResolvedSchema(new AnnotatedType(Thing.class)).schema)
