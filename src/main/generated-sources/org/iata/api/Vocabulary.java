...
public class Vocabulary {
     ...
     * 
     */
    public final static String s_c_AccessPermission = "https://onerecord.iata.org/ns/api#AccessPermission";
    public final static IRI c_AccessPermission = IRI.create(s_c_AccessPermission);
    /**
    ...
    public final static String s_p_hasLogisticsAgent = "https://onerecord.iata.org/ns/api#hasLogisticsAgent";
    public final static IRI p_hasLogisticsAgent = IRI.create(s_p_hasLogisticsAgent);
    /**
    ...
    /**
     * :Permission to get :AuditTrail of :LogisticsObject
     * 
     */
    public final static String s_i_GET_AUDIT_TRAIL = "https://onerecord.iata.org/ns/api#GET_AUDIT_TRAIL";
    public final static IRI i_GET_AUDIT_TRAIL = IRI.create(s_i_GET_AUDIT_TRAIL);
    /**
    ...
    /**
     * :Permission to post/request access delegation
     * 
     */
    public final static String s_i_POST_ACCESS_DELEGATION = "https://onerecord.iata.org/ns/api#POST_ACCESS_DELEGATION";
    public final static IRI i_POST_ACCESS_DELEGATION = IRI.create(s_i_POST_ACCESS_DELEGATION);
    /**
    ...
    /**
     * :Permission to post/request subscription
     * 
     */
    public final static String s_i_POST_SUBSCRIPTION = "https://onerecord.iata.org/ns/api#POST_SUBSCRIPTION";
    public final static IRI i_POST_SUBSCRIPTION = IRI.create(s_i_POST_SUBSCRIPTION);
